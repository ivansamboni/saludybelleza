  ...
  <div class="container" style="width:80%;">
    <div class="card"><br>
      <h3 class="text-center"><strong>
          <font-awesome-icon icon="fa-solid fa-money-check-dollar" /> Ventas de Gimnasio
      ...
      <div class="card-body">
        ...
        <button class="btn btn-success" @click="ventashoy()">Ventas de Hoy</button>&nbsp;
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalpago" @click="">Registrar
          Pago</button><br>
        <br>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <label for="name"><strong>Buscar Cliente</strong></label>
  ...
  result.apellidos
          ...
          <center>
            ...
            <input type="text" v-model="activacion.tipoventa" name="tipo" class="form-control"
              placeholder="Campo obligatorio"><br><br>

            <label for="precio"><strong>Precio (Sin puntos)</strong></label>
            <spam style="color:red;">(*)</spam>&nbsp;
            <input type="number" v-model="activacion.precio" name="precio" pattern="[0-9]" class="form-control"
