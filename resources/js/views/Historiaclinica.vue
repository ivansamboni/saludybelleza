          ...
          <div class="card-body">
            ...
            <div class="overflow-auto p-8 bg-light">
              <div class="list-group" role="group"><br>
                ...
                <button type="button" @click="registrocliente(clientes.id)"
                  class="list-group-item list-group-item-action">
                      ...
                      <div class="card"><br>
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-check form-check-inline" style="margin-left: 20px;">
                            ...
                            <input class="form-check-input" name="escalaradio1" type="radio"
                              v-model="clientes.escaladolor" value="1" id="inlineradio1" disabled>
                            <label class="form-check-label" for="inlineradio1">1</label>
                          </div>&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio2" type="radio"
                              v-model="clientes.escaladolor" value="2" id="inlineradio2" disabled>
                            <label class="form-check-label" for="inlineradio2">2</label>
                          </div>&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio3" type="radio"
                              v-model="clientes.escaladolor" value="3" id="inlineradio3" disabled>
                            <label class="form-check-label" for="inlineradio3">3</label>
                          </div>&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio4" type="radio"
                              v-model="clientes.escaladolor" value="4" id="inlineradio4" disabled>
                            <label class="form-check-label" for="inlineradio4">4</label>
                          </div>&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio5" type="radio"
                              v-model="clientes.escaladolor" value="5" id="inlineradio5" disabled>
                            <label class="form-check-label" for="inlineradio5">5</label>
                          </div>&nbsp;&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio6" type="radio"
                              v-model="clientes.escaladolor" value="6" id="inlineradio6" disabled>
                            <label class="form-check-label" for="inlineradio6">6</label>
                          </div>&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio7" type="radio"
                              v-model="clientes.escaladolor" value="7" id="inlineradio7" disabled>
                            <label class="form-check-label" for="inlineradio7">7</label>
                          </div>&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio8" type="radio"
                              v-model="clientes.escaladolor" value="8" id="inlineradio8" disabled>
                            <label class="form-check-label" for="inlineradio8">8</label>
                          </div>&nbsp;&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio9" type="radio"
                              v-model="clientes.escaladolor" value="9" id="inlineradio9" disabled>
                            <label class="form-check-label" for="inlineradio9">9</label>
                          </div>&nbsp;&nbsp;
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="escalaradio10" type="radio"
                              v-model="clientes.escaladolor" value="10" id="inlineradio10" disabled>
          ...
          <div class="col-sm-12">
            <div class="card mb-4" id="regiscliente" style="display:none;">
              <div class="card-body"><br>
                ...
                <div class="dropdown">
                  <button class="myButton3 dropdown-toggle" type="button" id="dropdownMenuButton1"
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                ...
                <input type="text" v-model="clientes.cancer" class="form-control form-control-sm"
                  placeholder="Especifique">
              </div>
              <div class="col-sm-2">
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="Otros" value="RMN"
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="Otros" value="TAC"
                    v-model="clientes.estparaclinicos">
                  <label class="form-check-label" for="Otros">
                    TAC
                  </label>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <center>
              ...
              <input type="text" v-model="activacion.tipoventa" name="tipo" class="form-control"><br><br>

              <label for="precio"><strong>Precio (Sin puntos)</strong></label>&nbsp;
              <input type="number" v-model="activacion.precio" name="precio" pattern="[0-9]" class="form-control"><br>
            </center>
            <br>
